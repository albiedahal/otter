...
class SelectiveHardeningStressUpdate : public RadialReturnStressUpdate
{
public:
  static InputParameters validParams();

  SelectiveHardeningStressUpdate(const InputParameters & parameters);
...
protected:
  ...
  MaterialProperty<bool> & _omega;
  const MaterialProperty<bool> & _omega_old;

  /// strength limits
  MaterialProperty<Real> & _maxstress;
  const MaterialProperty<Real> & _maxstress_old;

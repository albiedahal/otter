...
class RectangularBeamStress;

template <>
InputParameters validParams<RectangularBeamStress>();
 ...
 */
class RectangularBeamStress : public GeneralPostprocessor
{
public:
  static InputParameters validParams();

  RectangularBeamStress(const InputParameters & parameters);

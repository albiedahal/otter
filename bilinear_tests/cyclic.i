...
[Functions]
  [./load]
    ...
    y = '0   0.00064    0.0004   0.0009    -0.0002   0.001 -0.0005  0.0011  -0.0006 0.0012'
  ...
  [./load1]
    type = PiecewiseLinear
    x = '0   3          9        15       21       24     30        36'
    y = '0   0.0005    -0.00032   0.0010    -0.0010   0.0012 -0.0012  0.0014'
    # x = '0   3          9        15       21       24     30        36'
    # y = '0   0.0012    -0.0012   0.0014    -0.0014   0.0013 -0.0013  0.0015'
    # x = '0   3          9        15       21       24     30        36'
    # y = '0   0.001    -0.0005   0.0011    -0.0006   0.00115 -0.001  0.0013'
...
[Materials]
  ...
  [./kinematic_plasticity]
    ...
    # hardening_constant = 2.5e6
    deterioration_constant = -1e6
    # deterioration_constant = -2.9e6
    # peak_strength = 220.0
    peak_strength = 220

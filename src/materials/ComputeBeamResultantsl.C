...
registerMooseObject("TensorMechanicsApp", ComputeBeamResultantsl);

defineLegacyParams(ComputeBeamResultantsl);

InputParameters
ComputeBeamResultantsl::validParams()
{
...
ComputeBeamResultantsl::ComputeBeamResultantsl(const InputParameters & parameters)
  : Material(parameters),
...
void
ComputeBeamResultantsl::initQpStatefulProperties()
{
  _force[_qp].zero();
  _moment[_qp].zero();
}
...
void
ComputeBeamResultantsl::computeQpProperties()
{

...
registerMooseObject("TensorMechanicsApp", ComputeElasticityBeaml);

defineLegacyParams(ComputeElasticityBeaml);

InputParameters
ComputeElasticityBeaml::validParams()
{
...
ComputeElasticityBeaml::ComputeElasticityBeaml(const InputParameters & parameters)
  : Material(parameters),
...
{
  //
  // std::cout<<"constructor of CEB is called"<<std::endl;
  //
}

void
ComputeElasticityBeaml::computeQpProperties()
{
  //
  // std::cout<<"cP from CEB is called"<<std::endl;
  //
